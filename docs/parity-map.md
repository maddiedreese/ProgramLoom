...
| Complete calendar lifecycle               | `/app/events/{eventId}/calendar`             | Stable UID, incrementing sequence, `REQUEST`/`CANCEL`, explicit post-cancellation reschedule, delivery history, authorization tests, Gmail and Apple Calendar evidence |
