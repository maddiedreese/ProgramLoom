...
| `npm run check` (walkthrough hero release) | 0 | Typecheck, 61 unit/integration files with 236/236 tests, production builds, terminology, and evidence schema passed after the README and hero additions. |
